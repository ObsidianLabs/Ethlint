...
let plugins = {
    'solium-plugin-security': require('solium-plugin-security')
}
    ...
    load: function(config, noReset) {
        ...
        if (config.plugins && config.plugins.length) {
            ...
            function validatePlugin(pName) {
                ...
                try {
                    plugin = plugins[pName] || require(pName);
                } catch (e) {
        ...
        try {
            Object.assign(rules, ruleLoader.load(Object.keys(ruleConfigs), plugins));
        } catch (e) {
